...
public class ResponseBean {
    ...
    public Response getResponse(@PathParam("eventId") Long eventId, @PathParam("inviteId") Long personId) {
    ...
    public void putResponse(String userResponse, @PathParam("eventId") Long eventId,
